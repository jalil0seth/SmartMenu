                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('free_shipping') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="free_shipping" id="free_shipping" value="{{ old('free_shipping', '0') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('min_order') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="min_order" id="min_order" value="{{ old('min_order', '0') }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('adresse') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="adresse" id="adresse">{{ old('adresse') }}</textarea>
