                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.coupons.update", [$coupon->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('percentage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="percentage" id="percentage" value="{{ old('percentage', $coupon->percentage) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('valid') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="valid" id="valid" value="1" {{ $coupon->valid || old('valid', 0) === 1 ? 'checked' : '' }}>
