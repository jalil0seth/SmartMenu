                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('total') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total" id="total" value="{{ old('total', $order->total) }}" step="1">
                            @if($errors->has('total'))
                        ...
                        <div class="form-group {{ $errors->has('livraison') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="livraison" id="livraison" value="{{ old('livraison', $order->livraison) }}">
