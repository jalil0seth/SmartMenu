...
<body class="menu">
    <div class="header">
        ...
        <div id="navigationopenbutton" class="menubutton" @if ($host != 'v2.toptopdonuts.ma') style="display: none" @endif><a href="/ar" class="notification"><span> العربية <i class="fa-solid fa-earth-americas"></i></span></a> </div>
        <div class="nav">
